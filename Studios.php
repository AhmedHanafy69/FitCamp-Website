...
<body>
 ...
 <body>
   ...
   <p class="center"> <img src="stu.jpg" width="710px"</p>
   <video class="text" src="stu.mp4" controls loop width="400" >⁪</video>
   </div>
   ...
   <div class="content">
     <h1><span style="color:red">Stu</span>dios</h1>

     <p>Two dedicated studios cater to varied classes and brings the ultimate mixture of workouts to one place with a variety of sessions.
