...
<body>
 ...
 <body>
   ...
   <p class="center"> <img src="ice.jpg" width="600px"</p>
   </div>
   ...
   <div class="content">
     <h1><span style="color:red">Ice</span> Pack</h1>

     <p>Very important for athletes to reduce swelling and muscle damage from exercise, a service recently added to keep on track with all needs for our community.
